...
variants.df <- read_delim("Example_Monomeric_PDB/Example_input/SLC2A1_example_variant_input.txt", delim  = "\t")

protein_w_control.df <- read_delim("Example_Monomeric_PDB/Example_output/SLC2A1_protein_structure_chain_A_score_input.txt", delim  = "\t") %>% 
  mutate(variants = variants.df$control_variants)

protein_w_patient.df <- read_delim("Example_Monomeric_PDB/Example_output/SLC2A1_protein_structure_chain_A_score_input.txt", delim  = "\t") %>% 
...
density_test_combined(protein_w_patient.df,protein_w_control.df,file_path_expi,radius) %>% 
  ...
  write_delim("Example_Monomeric_PDB/Example_output/SLC2A1_3D_score_output.txt", delim = "\t")
